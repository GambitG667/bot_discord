...
argparser.add_argument("--token", "-t", metavar="TOKEN", type=str, default=None, help="Использует данный токен. В ином случае будет брать токен из переменных окружения")
